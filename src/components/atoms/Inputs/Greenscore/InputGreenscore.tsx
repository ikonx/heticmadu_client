...
const InputGreenscore: React.FC<Props> = ({DataGreenscore}) => {
  const [selectedValue, setSelectedValue] = React.useState<string | undefined>(DataGreenscore.radio[0].value);
  ...
  return (
    <ContainerRowInput>
      ...
      <RadioContainer>
        { DataGreenscore.radio.length > 0 && DataGreenscore.radio.map((item, i) => (
